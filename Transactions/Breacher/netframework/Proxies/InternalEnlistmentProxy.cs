...
namespace Miris.Transactions.Breacher.Proxies
{
        ...
        : BreacherProxy
    {
        ...
        {
            get => _ProxiedInstance.GetPrivateMemberValue<IEnlistmentNotification>("twoPhaseNotifications");
            set => _ProxiedInstance.SetPrivateMemberValue("twoPhaseNotifications", value);
        }

        public EnlistmentStateProxy TwoPhaseState
            => new EnlistmentStateProxy(() => _ProxiedInstance.GetPrivateMemberValue("twoPhaseState"));
